...
class LoginForm(AuthenticationForm):
    ...
    password = forms.CharField(label=_("Password"), strip=False, widget=forms.PasswordInput(attrs={'autocomplete':'current', 'class':'form-control'})) 


# My Password Change Form
